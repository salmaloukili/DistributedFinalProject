...
//           </Typography>
//           <Typography variant="body1" paragraph>
//             Date: {event.date ? new Date(event.date._seconds * 1000).toLocaleDateString() : 'Date not available'}
//           </Typography>
//           <Typography variant="body1" paragraph>
...
//               }}
//             >
//               <ImageComponent filePath={event.vendor.logo_url} style={{ width: '100%', height: 'auto' }} />
//             </Box>
