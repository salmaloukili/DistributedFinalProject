    ...
    <Grid container spacing={2}>
      {transportationOptions.map((option) => (
        <Grid item xs={12} sm={6} key={option.id}>
          <Card>
            <CardContent>
              <Typography variant="h6">Bus Model: {option.model}</Typography>
              ...
              <Button
                variant={selectedTransportation?.id === option.id ? 'contained' : 'outlined'}
                onClick={() => setSelectedTransportation(option)}
                sx={{ mt: 2 }}
              >
                {selectedTransportation?.id === option.id ? 'Selected' : 'Select'}
              </Button>
            </CardContent>
          </Card>
        </Grid>
        ...
        <Grid item xs={12} sm={6} key={option.id}>
          <Card>
            ...
            <CardContent>
              ...
              <Button
                variant={selectedFood?.id === option.id ? 'contained' : 'outlined'}
                onClick={() => setSelectedFood(option)}
                sx={{ mt: 2 }}
              >
                {selectedFood?.id === option.id ? 'Selected' : 'Select'}
              </Button>
            </CardContent>
          </Card>
        </Grid>
