...
const vendors = [
  {
    ...
    VENDOR_COMPANY_TYPE: "Catering",
    VENDOR_NUMBER: "1",
    VENDOR_SECRET_TOKEN: "token",
    VENDOR_NAME: "1BMkjSaBtyDLbtbanY18",
    VENDOR_URL: "http://127.0.0.1:5000",
  },
  {
    VENDOR_COMPANY_NAME: "Casteleyn, Faes en Vanhove CommV",
    VENDOR_COMPANY_TYPE: "Venue",
    VENDOR_NUMBER: "2",
    VENDOR_SECRET_TOKEN: "token",
    VENDOR_NAME: "PQSwnqknalhyBW8qPB2a",
    VENDOR_URL: "http://127.0.0.1:5000",
  },
  {
    VENDOR_COMPANY_NAME: "Callens VOF",
    ...
    VENDOR_NUMBER: "3",
    VENDOR_SECRET_TOKEN: "token",
    VENDOR_NAME: "AF8iRt7qkZfQ1cAj1D6z",
    VENDOR_URL: "http://127.0.0.1:5000",
  },
];
let caterSources = [];
